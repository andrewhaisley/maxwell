...
static void button_cb(
    ...
    XtPointer call_data)
{
    mx_search_d* d = (mx_search_d*)client_data;
    ...
    XtPointer call_data)
{
    ...
    s = XmTextGetString(d->pattern_text);
...
mx_search_d::mx_search_d(Widget parent)
    : mx_dialog("search", parent, TRUE, FALSE)
{
    Widget combo, label;
...
void mx_search_d::figure_options()
{
