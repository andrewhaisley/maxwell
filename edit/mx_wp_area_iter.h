 ...
 *
 */
#ifndef MX_WP_AREA_ITER_H
#define MX_WP_AREA_ITER_H

#include <mx_wp_iter.h>

class mx_wp_area_iterator : public mx_wp_iterator {
    // MX_RTTI(mx_wp_area_iterator_class_e)
