...
mx_gpoint_style::mx_gpoint_style(const char* name)
    : mx_geomstyle(name, mx_gstyle_point)
{
}

mx_gdash_style::mx_gdash_style(const char* name)
    : mx_geomstyle(name, mx_gstyle_dash)
{
}

mx_gline_style::mx_gline_style(const char* name)
    : mx_geomstyle(name, mx_gstyle_line)
{
}

mx_ghatch_style::mx_ghatch_style(const char* name)
    : mx_geomstyle(name, mx_gstyle_hatch)
{
}

mx_gfill_style::mx_gfill_style(const char* name)
    : mx_geomstyle(name, mx_gstyle_fill)
{
}

mx_gborder_style::mx_gborder_style(const char* name)
    : mx_geomstyle(name, mx_gstyle_border)
{
}

mx_garea_style::mx_garea_style(const char* name)
