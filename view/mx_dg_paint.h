 ...
 * DESCRIPTION:
 *
 * A class to draw diagram areas onto devices
 *
 *
 *
 *
 *
 */
#ifndef MX_DIAGRAM_AREA_PAINTER_H
#define MX_DIAGRAM_AREA_PAINTER_H
...
class mx_diagram_area_painter : public mx_area_painter {
    MX_RTTI(mx_diagram_area_painter_class_e)
